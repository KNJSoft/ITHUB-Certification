...
EMAIL_HOST_PASSWORD = 'tkryspvihzkmheku'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/6.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-9rv%by^#lh=6($%=-^^1psvuwkz2exh+h$45ue)asbuu)(r=^g'
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        ...
        {'name': 'Student Portal', 'description': 'Endpoints pour les étudiants'},
        {'name': 'Certifications', 'description': 'Gestion des attestations'},
        {'name': 'Admin Portal', 'description': 'Endpoints pour les administrateurs'},
    ]
}
