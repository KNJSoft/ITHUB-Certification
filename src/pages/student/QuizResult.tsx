        ...
        <div className={cn(
          ...
          <div className="flex justify-center mb-6 sm:mb-8 relative">
            {passed ? (
              ...
              >
                <Award size={40} className="text-white sm:size-48 md:size-56" />
              </motion.div>
            ) : (
              <motion.div
              ...
              >
                <XCircle size={40} className="text-red-500 sm:size-48 md:size-56" />
              </motion.div>
            )}
          </div>
        ...
        <div className="p-6 sm:p-8 md:p-12 space-y-6 sm:space-y-8 md:space-y-12">
          ...
          {passed ? (
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                <Download size={18} className="sm:size-22" strokeWidth={3} />
            ...
            <div className="space-y-4 sm:space-y-5">
              {remaining_attempts > 0 ? (
                ...
                >
                  <RefreshCw size={18} className="sm:size-22" />
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] text-center">
                   <AlertCircle size={24} className="text-red-500 mx-auto mb-2 sm:mb-3 sm:size-32" />
