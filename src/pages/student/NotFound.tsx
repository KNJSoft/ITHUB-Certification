...
export const NotFound: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
      ...
      >
        <div className="w-32 h-32 rounded-full bg-[#2563eb]/20 text-[#2563eb] mx-auto flex items-center justify-center mb-8">
          <AlertCircle size={64} />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            to="/app/dashboard"
            className="px-6 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-bold rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-[#2563eb]/20"
          >
            <Home size={18} />
            <span>Dashboard</span>
          </Link>
