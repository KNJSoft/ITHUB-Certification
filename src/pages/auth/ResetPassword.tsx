      ...
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 sm:p-6 md:p-8">
        ...
        >
          <div className="bg-[#1e293b] p-6 sm:p-8 rounded-3xl border border-[#334155] shadow-2xl text-center">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-[#f8fafc] mb-2">Mot de passe réinitialisé !</h1>
            <p className="text-[#94a3b8] text-sm sm:text-base">Votre mot de passe a été modifié avec succès. Redirection en cours...</p>
          </div>
        </motion.div>
      </div>
    );
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="block w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-[#0f172a] border border-[#2563eb] rounded-xl text-[#f8fafc] focus:outline-none focus:ring-2 focus:ring-[#2563eb]/50 focus:border-[#2563eb] transition-all text-center text-xl sm:text-2xl tracking-widest"
                placeholder="000000"
                maxLength={6}
                required
              />
