      ...
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
        ...
        >
          <div className="bg-[#1e293b] p-8 rounded-3xl border border-[#334155] shadow-2xl text-center">
            ...
            <h1 className="text-2xl font-bold text-[#f8fafc] mb-2">Email vérifié !</h1>
            <p className="text-[#94a3b8]">Votre compte a été activé avec succès. Redirection en cours...</p>
          </div>
        </motion.div>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#f8fafc] tracking-tight">Vérifier votre email</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="block w-full px-4 py-3 bg-[#0f172a] border border-[#334155] rounded-xl text-[#f8fafc] focus:outline-none focus:ring-2 focus:ring-[#2563eb]/50 focus:border-[#2563eb] transition-all text-center text-2xl tracking-widest"
                placeholder="000000"
                maxLength={6}
                required
              />
            ...
            <button
              ...
              disabled={resending}
              className="w-full bg-[#334155] hover:bg-[#475569] text-[#94a3b8] font-medium py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {resending ? (
